...
console.log(`[BOOT] Cold boot memory captured: ${
  (coldBootMemory.heapUsed / 1024 / 1024).toFixed(2)
} MB heap`);
...
app.get('/single', async (req, res) => {
  ...
  const complexity = parseInt(req.query.complexity as string) || 42;
